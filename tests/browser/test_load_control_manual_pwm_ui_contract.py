...
def test_manual_pwm_operator_control_requires_current_pwm_qualification() -> None:
...
def test_manual_pwm_operator_shows_quantized_ack_evidence_and_has_structured_css() -> None:
    ui = Path("frontend/js/load-control-stage3b-ui.js").read_text(encoding="utf-8")
